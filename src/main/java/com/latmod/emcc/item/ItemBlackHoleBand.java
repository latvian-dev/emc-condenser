...
public class ItemBlackHoleBand extends ItemEmcStorage implements IBauble
{
	...
	public void loadRecipes()
	{
		...
		{
			getMod().recipes.addRecipe(new ItemStack(this), "OEO", "EBE", "OEO", 'O', EMCCItems.UNUNSEPTIUM_BLOCK, 'B', EMCCItems.EMC_BATTERY, 'E', Items.ender_pearl);
		}
	}
