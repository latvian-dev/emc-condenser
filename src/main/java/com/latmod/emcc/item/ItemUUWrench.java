...
public class ItemUUWrench extends ItemToolEMCC
{
	...
	public void loadRecipes()
	{
		...
		{
			getMod().recipes.addRecipe(new ItemStack(this), "UBU", " S ", " S ", 'U', EMCCItems.UNUNSEPTIUM_BLOCK, 'S', ODItems.STICK, 'B', EMCCItems.EMC_BATTERY);
		}
	}
	...
	{
		if (!ep.canPlayerEdit(x, y, z, side, is))
		{
			return false;
		}
