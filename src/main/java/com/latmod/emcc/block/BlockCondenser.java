...
import com.latmod.emcc.client.render.world.RenderCondenser;
...
public class BlockCondenser extends BlockEMCC
{
	...
	{
		EMCC.mod.recipes.addRecipe(new ItemStack(EMCCItems.CONDENSER), "OBO", "ASA", "OIO", 'O', EMCCItems.UNUNSEPTIUM_BLOCK, 'I', ItemMaterialsEMCC.MINIUM_STAR, 'B', EMCCItems.BLACK_HOLE_BAND, 'S', Blocks.diamond_block, 'A', ODItems.OBSIDIAN);
	}
