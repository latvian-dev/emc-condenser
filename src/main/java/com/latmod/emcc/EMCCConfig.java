...
public class EMCCConfig
{
	...
	public static class Tools
	{
		...
		public double tool_emc_per_damage = 64D;

		@Config.RangeDouble(min = 0D)
		public double life_stone_1hp = 24D;

		@Config.RangeDouble(min = 0D)
		public double life_stone_food = 128D;

		@Config.RangeDouble(min = 0D)
		public double life_stone_extinguish = 64D;

		@Config.RangeDouble(min = 0D)
		public double black_hole_stone_item = 48D;

		@Config.RangeDouble(min = 0D, max = 64D)
		public double black_hole_stone_range = 4D;
